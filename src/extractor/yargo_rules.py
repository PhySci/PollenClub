...
DICT_CITY1 = set(load_lines(os.path.join(dir_path, 'dict/dict_city1.txt')))
DICT_CITY2 = set(load_lines(os.path.join(dir_path,'dict/dict_city2.txt')))
DICT_RESP = set(load_lines(os.path.join(dir_path,'dict/dict_resp.txt')))
DICT_KRAI = set(load_lines(os.path.join(dir_path,'dict/dict_krai.txt')))
DICT_OBL = set(load_lines(os.path.join(dir_path,'dict/dict_obl.txt')))
DICT_OKRUG = set(load_lines(os.path.join(dir_path,'dict/dict_okrug.txt')))
DICT_RAION = set(load_lines(os.path.join(dir_path,'dict/dict_raion.txt')))
DICT_MSK_R = set(load_lines(os.path.join(dir_path,'dict/dict_msk_r.txt')))
